...
class DeribitExchange(object):
    ...
    url_transaction_log = "https://www.deribit.com/api/v2/private/get_transaction_log?count={}&currency={}&start_timestamp={}&end_timestamp={}"
    ...
    def get_transaction_log(self, currency, start_timestamp, end_timestamp, count=100):
        return self._private_request(self.url_transaction_log, count, currency, start_timestamp, end_timestamp)["logs"]
